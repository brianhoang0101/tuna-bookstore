    ...
    <>
      ...
      <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
          <blockquote class="tiktok-embed" cite="https://www.tiktok.com/@tusach.dangquy" data-unique-id="tusach.dangquy" data-embed-type="creator" style={{maxWidth:"780px", minWidth:"288px"}} > <section> <a target="_blank" href="https://www.tiktok.com/@tusach.dangquy?refer=creator_embed">@tusach.dangquy</a> </section> </blockquote> <script async src="https://www.tiktok.com/embed.js"></script>
          <blockquote class="tiktok-embed" cite="https://www.tiktok.com/@tusachgiauco" data-unique-id="tusachgiauco" data-embed-type="creator" style={{maxWidth:"780px", minWidth:"288px"}} > <section> <a target="_blank" href="https://www.tiktok.com/@tusachgiauco?refer=creator_embed">@tusachgiauco</a> </section> </blockquote> <script async src="https://www.tiktok.com/embed.js"></script>
          <blockquote class="tiktok-embed" cite="https://www.tiktok.com/@tusachbinhyen" data-unique-id="tusachbinhyen" data-embed-type="creator" style={{maxWidth:"780px", minWidth:"288px"}} > <section> <a target="_blank" href="https://www.tiktok.com/@tusachbinhyen?refer=creator_embed">@tusachbinhyen</a> </section> </blockquote> <script async src="https://www.tiktok.com/embed.js"></script>
          <blockquote class="tiktok-embed" cite="https://www.tiktok.com/@nhalanhdaotuonglai" data-unique-id="nhalanhdaotuonglai" data-embed-type="creator" style={{maxWidth:"780px", minWidth:"288px"}} > <section> <a target="_blank" href="https://www.tiktok.com/@nhalanhdaotuonglai?refer=creator_embed">@nhalanhdaotuonglai</a> </section> </blockquote> <script async src="https://www.tiktok.com/embed.js"></script>
        </div>
      </div>
...
export async function getStaticProps() {
  const searchResults = await getBestSellerProducts()
